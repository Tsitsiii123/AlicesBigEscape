...
public class QuestManager : MonoBehaviour
{
    ...
    public void StopAndCheckTimer(float minTime, float maxTime)
    {
        ...
        if (currentTimer < minTime) // Check if the elapsed time is less than the minimum time
        {
            ...
            ShowCollectionMessage("Difficulty increased."); // Show a message to the player indicating that the difficulty has been increased due to completing the task too quickly
        }
        else if (currentTimer > maxTime) // Check if the elapsed time is greater than the maximum time
        {
            ...
            ShowCollectionMessage("Difficulty decreased."); // Show a message to the player indicating that the difficulty has been decreased due to taking too long to complete the task
        }
